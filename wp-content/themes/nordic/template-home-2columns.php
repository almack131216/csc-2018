...
?>
    ...
    <div class="home_four container left-space">
        ...
        <?php
            $fourcolumns_default = 'none';
            $fourcolumns_active = '';
            if(get_field("default_grid") == "4columns") {
                $fourcolumns_default = 'block';
                $fourcolumns_active = 'active';
            }

            $threecolumns_default = 'none';
            $threecolumns_active = '';
            if(get_field("default_grid") == "3columns") {
                $threecolumns_default = 'block';
                $threecolumns_active = 'active';
            }

            $twocolumns_default = 'none';
            $twocolumns_active = '';
            if(get_field("default_grid") == "2columns") {
                $twocolumns_default = 'block';
                $twocolumns_active = 'active';
            }

            if(get_field("default_grid") == "") {
                $fourcolumns_default = 'block';
                $fourcolumns_active = 'active';
            }
        ?>
        ...
        <div class="col-switcher">
            <a href="#" class="col-four project_col_four <?php echo $fourcolumns_active ?>"><i class="icon-th"></i></a>
            <a href="#" class="col-two project_col_three <?php echo $threecolumns_active ?>"><i class="icon-th"></i></a>
            <a href="#" class="col-two project_col_two <?php echo $twocolumns_active ?>"><i class="icon-th-large"></i></a>
        </div>

        <div class="column-4 row" style="display:<?php echo $fourcolumns_default ?>">
            <?php
            $arguments = array();
        ...
        <div class="column-3 row" style="display:<?php echo $threecolumns_default ?>">
            <?php
            $arguments = array();
            $arguments["post_type"] = "portfolio";
            if(get_field("include_only_those_categories") || get_field("exclude_categories")){
            ...
            $arguments["posts_per_page"] = get_field("number_of_posts_3columns");
            $the_query = new WP_Query( $arguments );
            while ( $the_query->have_posts() ) :  $the_query->the_post();
                ?>
        ...
        <div class="column-2 row" style="display:<?php echo $twocolumns_default ?>">
            <?php
            $arguments = array();
            $arguments["post_type"] = "portfolio";
            if(get_field("include_only_those_categories") || get_field("exclude_categories")){
